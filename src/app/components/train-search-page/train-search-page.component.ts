...
export class TrainSearchPageComponent implements OnInit {
  ...
  sortByType():void{
    this.trainTrips.sort((a,b) => a.train.name.localeCompare(b.train.name))
  }
  
  sortByClass():void{
    this.trainTrips.sort((a,b) => a.train.trainClass.className.localeCompare(b.train.trainClass.className))
  }
